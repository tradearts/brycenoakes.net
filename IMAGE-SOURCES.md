...
`TA HQ/TA_PORTFOLIO/05_BEST_PROJECT_IMAGES/00_CURATED_MASTER_2026-07`

- Pterodactyl source Drive ID `1oVbCzDGdVx0Vva4oWUBbUHBuZbxZln_P` -> `images/portfolio/pterodactyl.webp`
- Model Aircraft source Drive ID `1uTYCr41d6uhv1fLCtXeLkf9zaGxYnbe1` -> `images/portfolio/model-aircraft-side.webp`
- Model Aircraft source Drive ID `1Gxk9IUO0WqNBpE8eh3ZRNjnE-m0CMW87` -> `images/portfolio/model-aircraft-group.webp`
- Workshop source Drive ID `1NoU9Iar7mXw_p3bzRxp2PkEnAXNBzBgt` -> `images/portfolio/workshop-wide.webp`
- Workshop source Drive ID `1tHsEuq-8gGRL3rCV7OBMQzpcNQWbpM1C` -> `images/portfolio/workshop-working.webp`

## Coffs Harbour reVITALise

Source:

`reVITALise Stage 01 Concept Deliverable 04 - Terracotta Sculpture Renders.pdf`
